...
public fun TagConsumer<HTMLElement>.area(shape : AreaShape? = null, alt : String? = null, classes : String? = null, content : String = "") : HTMLAreaElement = build(listOf("Shape" to shape?.enumEncode(),"alt" to alt,"class" to stringSetDecode(classes)?.stringSetEncode()).toAttributesMap(), ::buildAREA, {+content}).finalize() as HTMLAreaElement
...
public fun TagConsumer<HTMLElement>.base(classes : String? = null, content : String = "") : HTMLBaseElement = build(listOf("class" to stringSetDecode(classes)?.stringSetEncode()).toAttributesMap(), ::buildBASE, {+content}).finalize() as HTMLBaseElement
...
public fun TagConsumer<HTMLElement>.br(classes : String? = null, content : String = "") : HTMLBRElement = build(listOf("class" to stringSetDecode(classes)?.stringSetEncode()).toAttributesMap(), ::buildBR, {+content}).finalize() as HTMLBRElement
...
public fun TagConsumer<HTMLElement>.col(classes : String? = null, content : String = "") : HTMLElement = build(listOf("class" to stringSetDecode(classes)?.stringSetEncode()).toAttributesMap(), ::buildCOL, {+content}).finalize()
...
public fun TagConsumer<HTMLElement>.command(type : CommandType? = null, classes : String? = null, content : String = "") : HTMLElement = build(listOf("type" to type?.enumEncode(),"class" to stringSetDecode(classes)?.stringSetEncode()).toAttributesMap(), ::buildCOMMAND, {+content}).finalize()
...
public fun TagConsumer<HTMLElement>.embed(classes : String? = null, content : String = "") : HTMLEmbedElement = build(listOf("class" to stringSetDecode(classes)?.stringSetEncode()).toAttributesMap(), ::buildEMBED, {+content}).finalize() as HTMLEmbedElement
...
public fun TagConsumer<HTMLElement>.hr(classes : String? = null, content : String = "") : HTMLHRElement = build(listOf("class" to stringSetDecode(classes)?.stringSetEncode()).toAttributesMap(), ::buildHR, {+content}).finalize() as HTMLHRElement
...
public fun TagConsumer<HTMLElement>.img(alt : String? = null, src : String? = null, classes : String? = null, content : String = "") : HTMLImageElement = build(listOf("alt" to alt,"src" to src,"class" to stringSetDecode(classes)?.stringSetEncode()).toAttributesMap(), ::buildIMG, {+content}).finalize() as HTMLImageElement
...
public fun TagConsumer<HTMLElement>.input(type : InputType? = null, formEncType : InputFormEncType? = null, formMethod : InputFormMethod? = null, name : String? = null, classes : String? = null, content : String = "") : HTMLInputElement = build(listOf("type" to type?.enumEncode(),"formenctype" to formEncType?.enumEncode(),"formmethod" to formMethod?.enumEncode(),"name" to name,"class" to stringSetDecode(classes)?.stringSetEncode()).toAttributesMap(), ::buildINPUT, {+content}).finalize() as HTMLInputElement
...
public fun TagConsumer<HTMLElement>.keyGen(keyType : KeyGenKeyType? = null, classes : String? = null, content : String = "") : HTMLElement = build(listOf("keytype" to keyType?.enumEncode(),"class" to stringSetDecode(classes)?.stringSetEncode()).toAttributesMap(), ::buildKEYGEN, {+content}).finalize()
...
public fun TagConsumer<HTMLElement>.link(classes : String? = null, content : String = "") : HTMLLinkElement = build(listOf("class" to stringSetDecode(classes)?.stringSetEncode()).toAttributesMap(), ::buildLINK, {+content}).finalize() as HTMLLinkElement
...
public fun TagConsumer<HTMLElement>.meta(classes : String? = null, content : String = "") : HTMLMetaElement = build(listOf("class" to stringSetDecode(classes)?.stringSetEncode()).toAttributesMap(), ::buildMETA, {+content}).finalize() as HTMLMetaElement
public fun TagConsumer<HTMLElement>.meta(classes : String? = null, block : META.() -> Unit) : HTMLMetaElement = build(listOf("class" to stringSetDecode(classes)?.stringSetEncode()).toAttributesMap(), ::buildMETA, block).finalize() as HTMLMetaElement
...
public fun TagConsumer<HTMLElement>.source(classes : String? = null, content : String = "") : HTMLSourceElement = build(listOf("class" to stringSetDecode(classes)?.stringSetEncode()).toAttributesMap(), ::buildSOURCE, {+content}).finalize() as HTMLSourceElement
