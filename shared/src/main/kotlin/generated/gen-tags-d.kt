...
public class DETAILS(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*>) : HTMLTag("details", consumer, initialAttributes), CommonEventsGroupFacade, CoreAttributeGroupFacade, CoreServerAttributeGroupFacade {
    ...
    override
    fun legEnd(block : LEGEND.() -> Unit) : Unit = super<HTMLTag>.legEnd(block)
...
public class DL(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*>) : HTMLTag("dl", consumer, initialAttributes), CommonEventsGroupFacade, CoreAttributeGroupFacade, CoreServerAttributeGroupFacade {
    ...
    override
    fun dd(block : DD.() -> Unit) : Unit = super<HTMLTag>.dd(block)

    override
    fun dt(block : DT.() -> Unit) : Unit = super<HTMLTag>.dt(block)
