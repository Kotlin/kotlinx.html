...
open class MAP(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*>) : HTMLTag("map", consumer, initialAttributes), CommonAttributeGroupFacadeFlowContentPhrasingContent {
    var name : String
...
open class MARK(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*>) : HTMLTag("mark", consumer, initialAttributes), CommonAttributeGroupFacadePhrasingContent {

}

open class MATH(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*>) : HTMLTag("math", consumer, initialAttributes), CommonAttributeGroupFacadePhrasingContent {
...
open class MENU(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*>) : HTMLTag("menu", consumer, initialAttributes), CommonAttributeGroupFacadeFlowContent {
    var type : MenuType
...
open class METER(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*>) : HTMLTag("meter", consumer, initialAttributes), CommonAttributeGroupFacadePhrasingContent {
    var value : String
