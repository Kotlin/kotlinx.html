...
public class HEAD(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*>) : HTMLTag("head", consumer, initialAttributes), CommonEventsGroupFacade, CoreAttributeGroupFacade, CoreServerAttributeGroupFacade {
    ...
    override
    fun base(content : String) : Unit = super<HTMLTag>.base(content)
    ...
    override
    fun title(content : String) : Unit = super<HTMLTag>.title(content)
...
public class HTML(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*>) : HTMLTag("html", consumer, initialAttributes), CommonEventsGroupFacade, CoreAttributeGroupFacade, CoreServerAttributeGroupFacade {
    var manifest : String by attributeStringf30f39f0

    override
    fun body(block : BODY.() -> Unit) : Unit = super<HTMLTag>.body(block)

    override
    fun head(block : HEAD.() -> Unit) : Unit = super<HTMLTag>.head(block)
