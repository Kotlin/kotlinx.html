...
fun HGROUP.h1(classes : Set<String>? = null, block : H1.() -> Unit) : Unit = buildH1(listOf("class" to classes?.stringSetEncode()).toAttributesMap(), consumer, block)

fun HGROUP.h2(classes : Set<String>? = null, block : H2.() -> Unit) : Unit = buildH2(listOf("class" to classes?.stringSetEncode()).toAttributesMap(), consumer, block)

fun HGROUP.h3(classes : Set<String>? = null, block : H3.() -> Unit) : Unit = buildH3(listOf("class" to classes?.stringSetEncode()).toAttributesMap(), consumer, block)

fun HGROUP.h4(classes : Set<String>? = null, block : H4.() -> Unit) : Unit = buildH4(listOf("class" to classes?.stringSetEncode()).toAttributesMap(), consumer, block)

fun HGROUP.h5(classes : Set<String>? = null, block : H5.() -> Unit) : Unit = buildH5(listOf("class" to classes?.stringSetEncode()).toAttributesMap(), consumer, block)

fun HGROUP.h6(classes : Set<String>? = null, block : H6.() -> Unit) : Unit = buildH6(listOf("class" to classes?.stringSetEncode()).toAttributesMap(), consumer, block)
...
fun HTML.body(classes : Set<String>? = null, block : BODY.() -> Unit) : Unit = buildBODY(listOf("class" to classes?.stringSetEncode()).toAttributesMap(), consumer, block)

fun HTML.head(classes : Set<String>? = null, block : HEAD.() -> Unit) : Unit = buildHEAD(listOf("class" to classes?.stringSetEncode()).toAttributesMap(), consumer, block)
