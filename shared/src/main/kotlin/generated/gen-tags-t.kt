...
public class TABLE(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*>) : HTMLTag("table", consumer, initialAttributes), CommonEventsGroupFacade, CoreAttributeGroupFacade, CoreServerAttributeGroupFacade {
    ...
    override
    fun caption(block : CAPTION.() -> Unit) : Unit = super<HTMLTag>.caption(block)

    override
    fun colGroup(block : COLGROUP.() -> Unit) : Unit = super<HTMLTag>.colGroup(block)

    override
    fun tbody(block : TBODY.() -> Unit) : Unit = super<HTMLTag>.tbody(block)

    override
    fun tfoot(block : TFOOT.() -> Unit) : Unit = super<HTMLTag>.tfoot(block)

    override
    fun thead(block : THEAD.() -> Unit) : Unit = super<HTMLTag>.thead(block)

    override
    fun tr(block : TR.() -> Unit) : Unit = super<HTMLTag>.tr(block)
...
public class TR(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*>) : HTMLTag("tr", consumer, initialAttributes), CommonEventsGroupFacade, CoreAttributeGroupFacade, CoreServerAttributeGroupFacade {
    ...
    override
    fun td(block : TD.() -> Unit) : Unit = super<HTMLTag>.td(block)

    override
    fun th(block : TH.() -> Unit) : Unit = super<HTMLTag>.th(block)
