...
public open class HTMLTag(override val name : String, override val consumer : TagConsumer<*>, val initialAttributes : Map<String, String>) : Tag {
    ...
    open fun textarea(content : String = "") : Unit = buildTEXTAREA(emptyMap(), consumer, {+content})
    deprecated("you shouldn't use tag textarea here")
    open fun textarea(block : TEXTAREA.() -> Unit) : Unit = buildTEXTAREA(emptyMap(), consumer, block)
    ...
    open fun input(content : String = "") : Unit = buildINPUT(emptyMap(), consumer, {+content})
    deprecated("you shouldn't use tag input here")
    open fun input(block : INPUT.() -> Unit) : Unit = buildINPUT(emptyMap(), consumer, block)
    ...
    open fun area(content : String = "") : Unit = buildAREA(emptyMap(), consumer, {+content})
    deprecated("you shouldn't use tag area here")
    open fun area(block : AREA.() -> Unit) : Unit = buildAREA(emptyMap(), consumer, block)
    ...
    open fun img(src : String? = null, content : String = "") : Unit = buildIMG(listOf("src" to src).toAttributesMap(), consumer, {+content})
    deprecated("you shouldn't use tag img here")
    open fun img(src : String? = null, block : IMG.() -> Unit) : Unit = buildIMG(listOf("src" to src).toAttributesMap(), consumer, block)
    ...
    open fun form(block : FORM.() -> Unit) : Unit = buildFORM(emptyMap(), consumer, block)
