...
class TestStreaming {
  ...
  fun `we should be able to make extension functions with DSL`() {
    assertEquals("<html><body><div class=\"block deprecated\"><a href=\"http://kotlinlang.org\" target=\"_blank\" custom=\"custom\">test me</a></div></body></html>",
  ...
  fun `empty tag should have attributes`() {
    ...
    assertEquals("<div id=\"d\"><div id=\"d2\"></div></div>",
