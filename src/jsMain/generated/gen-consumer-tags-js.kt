 ...
 */
@HtmlTagMarker
public inline fun TagConsumer<HTMLElement, Event>.picture(crossinline block : PICTURE<Event>.() -> Unit = {}) : HTMLPictureElement = PICTURE(emptyMap, this).visitAndFinalize(this, block) as HTMLPictureElement
