...
@Suppress("unused")
open class I<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
    HTMLTag<E>("i", consumer, initialAttributes, null, true, false), HtmlBlockInlineTag<E>
...
@Suppress("unused")
open class IFRAME<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
    HTMLTag<E>("iframe", consumer, initialAttributes, null, true, false),
...
@Suppress("unused")
open class IMG<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
    HTMLTag<E>("img", consumer, initialAttributes, null, true, true),
    CommonAttributeGroupFacadeFlowInteractivePhrasingContent<E> {
    var alt: String
...
@Suppress("unused")
open class INPUT<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
    HTMLTag<E>("input", consumer, initialAttributes, null, true, true),
    CommonAttributeGroupFacadeFlowInteractivePhrasingContent<E> {
    var type: InputType
...
@Suppress("unused")
open class INS<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
    HTMLTag<E>("ins", consumer, initialAttributes, null, false, false), HtmlBlockInlineTag<E> {
    var cite: String
