...
@Suppress("unused")
open class B<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
  HTMLTag<E>("b", consumer, initialAttributes, null, true, false), HtmlBlockInlineTag<E>
...
@Suppress("unused")
open class BASE<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
  HTMLTag<E>("base", consumer, initialAttributes, null, true, true), HtmlHeadTag<E> {
  var href: String
...
@Suppress("unused")
open class BDI<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
  HTMLTag<E>("bdi", consumer, initialAttributes, null, true, false), HtmlBlockInlineTag<E>
...
@Suppress("unused")
open class BDO<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
  HTMLTag<E>("bdo", consumer, initialAttributes, null, true, false), HtmlBlockInlineTag<E>
...
@Suppress("unused")
open class BLOCKQUOTE<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
  HTMLTag<E>("blockquote", consumer, initialAttributes, null, false, false), HtmlBlockTag<E> {
  var cite: String
...
@Suppress("unused")
open class BODY<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
  HTMLTag<E>("body", consumer, initialAttributes, null, false, false), HtmlBlockTag<E> {
...
@Suppress("unused")
open class BR<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
  HTMLTag<E>("br", consumer, initialAttributes, null, true, true), HtmlBlockInlineTag<E>
...
@Suppress("unused")
open class BUTTON<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
  HTMLTag<E>("button", consumer, initialAttributes, null, true, false),
