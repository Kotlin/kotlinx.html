...
@Suppress("unused")
open class LABEL<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("label", consumer, initialAttributes, null, true, false), CommonAttributeGroupFacadeFlowInteractivePhrasingContent<E> {
    var form : String
...
@Suppress("unused")
open class LEGEND<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("legend", consumer, initialAttributes, null, true, false), HtmlBlockInlineTag<E> {
...
@Suppress("unused")
open class LI<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("li", consumer, initialAttributes, null, false, false), HtmlBlockTag<E> {
    var value : String
...
@Suppress("unused")
open class LINK<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("link", consumer, initialAttributes, null, false, true), CommonAttributeGroupFacadeFlowMetaDataPhrasingContent<E> {
    var href : String
