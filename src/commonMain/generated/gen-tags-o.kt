...
@Suppress("unused")
open class OBJECT<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("object", consumer, initialAttributes, null, true, false), CommonAttributeGroupFacadeFlowInteractivePhrasingContent<E> {
    var data : String
 ...
 */
@HtmlTagMarker
inline fun <E> OBJECT<E>.param(name : String? = null, value : String? = null, crossinline block : PARAM<E>.() -> Unit = {}) : Unit = PARAM(attributesMapOf("name", name,"value", value), consumer).visit(block)
...
@Suppress("unused")
open class OL<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("ol", consumer, initialAttributes, null, false, false), HtmlBlockTag<E> {
    var start : String
 ...
 */
@HtmlTagMarker
inline fun <E> OL<E>.li(classes : String? = null, crossinline block : LI<E>.() -> Unit = {}) : Unit = LI(attributesMapOf("class", classes), consumer).visit(block)


@Suppress("unused")
open class OPTGROUP<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("optgroup", consumer, initialAttributes, null, true, false), CommonAttributeGroupFacade<E> {
 ...
 */
@HtmlTagMarker
inline fun <E> OPTGROUP<E>.option(classes : String? = null, crossinline block : OPTION<E>.() -> Unit = {}) : Unit = OPTION(attributesMapOf("class", classes), consumer).visit(block)
/**
 * Selectable choice
 */
@HtmlTagMarker
fun <E> OPTGROUP<E>.option(classes : String? = null, content : String = "") : Unit = OPTION(attributesMapOf("class", classes), consumer).visit({+content})


@Suppress("unused")
open class OPTION<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("option", consumer, initialAttributes, null, true, false), CommonAttributeGroupFacade<E> {
    var disabled : Boolean
        get()  = attributeBooleanTicker.get(this, "disabled")
        set(newValue) {attributeBooleanTicker.set(this, "disabled", newValue)}
...
@Suppress("unused")
open class OUTPUT<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("output", consumer, initialAttributes, null, true, false), HtmlBlockInlineTag<E> {
    var htmlFor : String
