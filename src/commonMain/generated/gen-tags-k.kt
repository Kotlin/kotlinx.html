...
@Suppress("unused")
open class KBD<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("kbd", consumer, initialAttributes, null, true, false), HtmlBlockInlineTag<E> {
...
@Suppress("unused")
open class KEYGEN<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("keygen", consumer, initialAttributes, null, true, true), CommonAttributeGroupFacadeFlowInteractivePhrasingContent<E> {
