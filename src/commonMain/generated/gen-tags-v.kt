...
@Suppress("unused")
open class VAR<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("var", consumer, initialAttributes, null, true, false), HtmlBlockInlineTag<E> {
...
@Suppress("unused")
open class VIDEO<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("video", consumer, initialAttributes, null, false, false), CommonAttributeGroupFacadeFlowInteractivePhrasingContent<E> {
    var src : String
 ...
 */
@HtmlTagMarker
inline fun <E> VIDEO<E>.source(classes : String? = null, crossinline block : SOURCE<E>.() -> Unit = {}) : Unit = SOURCE(attributesMapOf("class", classes), consumer).visit(block)
