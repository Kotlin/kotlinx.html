...
@Suppress("unused")
open class MAIN<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
  HTMLTag<E>("main", consumer, initialAttributes, null, false, false),
  CommonAttributeGroupFacadeFlowPhrasingSectioningContent<E>

@Suppress("unused")
open class MAP<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
  HTMLTag<E>("map", consumer, initialAttributes, null, true, false), HtmlBlockInlineTag<E> {
  var name: String
...
@Suppress("unused")
open class MARK<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
  HTMLTag<E>("mark", consumer, initialAttributes, null, true, false), HtmlBlockInlineTag<E>
...
@Suppress("unused")
open class MATH<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
  HTMLTag<E>("math", consumer, initialAttributes, null, false, false), HtmlBlockInlineTag<E>
...
@Suppress("unused")
open class MATHML<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
  HTMLTag<E>("mathml", consumer, initialAttributes, null, false, false), CommonAttributeGroupFacade<E>

@Suppress("unused")
open class META<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
  HTMLTag<E>("meta", consumer, initialAttributes, null, false, true),
...
@Suppress("unused")
open class METER<E>(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*, E>) :
  HTMLTag<E>("meter", consumer, initialAttributes, null, true, false), HtmlBlockInlineTag<E> {
  var value: String
