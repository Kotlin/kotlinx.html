...
@Suppress("unused")
open class A<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("a", consumer, initialAttributes, null, true, false), CommonAttributeGroupFacadeFlowInteractivePhrasingContent<E> {
    var href : String
...
@Suppress("unused")
open class ABBR<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("abbr", consumer, initialAttributes, null, true, false), HtmlBlockInlineTag<E> {
...
@Suppress("unused")
open class ADDRESS<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("address", consumer, initialAttributes, null, false, false), HtmlBlockTag<E> {

}

@Suppress("unused")
open class AREA<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("area", consumer, initialAttributes, null, true, true), HtmlBlockInlineTag<E> {
    var coords : String
...
@Suppress("unused")
open class ARTICLE<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("article", consumer, initialAttributes, null, false, false), CommonAttributeGroupFacadeFlowSectioningContent<E> {
...
@Suppress("unused")
open class ASIDE<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("aside", consumer, initialAttributes, null, false, false), CommonAttributeGroupFacadeFlowSectioningContent<E> {
...
@Suppress("unused")
open class AUDIO<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("audio", consumer, initialAttributes, null, false, false), CommonAttributeGroupFacadeFlowInteractivePhrasingContent<E> {
    var src : String
 ...
 */
@HtmlTagMarker
inline fun <E> AUDIO<E>.source(classes : String? = null, crossinline block : SOURCE<E>.() -> Unit = {}) : Unit = SOURCE(attributesMapOf("class", classes), consumer).visit(block)
