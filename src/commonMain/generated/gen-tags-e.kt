...
@Suppress("unused")
open class EM<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("em", consumer, initialAttributes, null, true, false), HtmlBlockInlineTag<E> {
...
@Suppress("unused")
open class EMBED<E>(initialAttributes : Map<String, String>, override val consumer : TagConsumer<*, E>) : HTMLTag<E>("embed", consumer, initialAttributes, null, true, true), CommonAttributeGroupFacadeFlowInteractivePhrasingContent<E> {
    var src : String
