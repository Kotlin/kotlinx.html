...
@Suppress("unused")
open class DATALIST(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*>) :
    HTMLTag("datalist", consumer, initialAttributes, null, true, false), HtmlBlockInlineTag
 ...
 */
@HtmlTagMarker
fun DATALIST.option(classes: String? = null, content: String = ""): Unit =
...
@Suppress("unused")
open class DD(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*>) :
    HTMLTag("dd", consumer, initialAttributes, null, false, false), HtmlBlockTag

@Suppress("unused")
open class DEL(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*>) :
    HTMLTag("del", consumer, initialAttributes, null, false, false), HtmlBlockInlineTag {
    var cite: String
...
@Suppress("unused")
open class DETAILS(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*>) :
    HTMLTag("details", consumer, initialAttributes, null, false, false),
...
@Suppress("unused")
open class DFN(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*>) :
    HTMLTag("dfn", consumer, initialAttributes, null, true, false), HtmlBlockInlineTag
...
@Suppress("unused")
open class DIALOG(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*>) :
    HTMLTag("dialog", consumer, initialAttributes, null, false, false), HtmlBlockTag
...
@Suppress("unused")
open class DL(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*>) :
    HTMLTag("dl", consumer, initialAttributes, null, false, false), HtmlBlockTag
...
@Suppress("unused")
open class DT(initialAttributes: Map<String, String>, override val consumer: TagConsumer<*>) :
    HTMLTag("dt", consumer, initialAttributes, null, false, false), HtmlInlineTag
